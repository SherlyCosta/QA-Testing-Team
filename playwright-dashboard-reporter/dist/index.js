    ...
    onBegin(config, suite) {
        ...
        if (config.projects && config.projects.length > 0) {
            ...
            for (const proj of config.projects) {
                const bName = ((_e = proj.use) === null || _e === void 0 ? void 0 : _e.browserName) || ((_f = proj.use) === null || _f === void 0 ? void 0 : _f.defaultBrowserType) || proj.name || 'Unknown';
                const headless = ((_g = proj.use) === null || _g === void 0 ? void 0 : _g.headless) !== false ? 'true' : 'false';
                const viewport = ((_h = proj.use) === null || _h === void 0 ? void 0 : _h.viewport) ? `${proj.use.viewport.width}x${proj.use.viewport.height}` : 'Unknown';
